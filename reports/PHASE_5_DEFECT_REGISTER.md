...
| RUN-1: TimeoutStartSec=120 is the enforced oneshot bound; RuntimeMaxSec dead config | medium | CODE-FIXED 2026-08-02: RuntimeMaxSec removed from all 3 oneshot units (509a6b4, test-pinned absent). Reaches the host at the next re-pin after merge. |
