...
| LA-10 | MEDIUM | preston-os-staging (AUTHORITATIVE staging DB, ~29 MB) has NO backups - "Last Backup: No backups.", Free Plan excludes scheduled backups. Accidental deletion/corruption of business records, approvals, and audit trail would be unrecoverable | OWNER-VERIFIED 2026-07-21/22 | OPEN - Gate 0 (2026-07-22) confirmed NO paid org exists, so provider-backup transfer is unavailable now; OPERATIVE remediation = Option B hybrid pg_dump (first-backup packet). Owner may later create a Pro org to add provider daily backups |
| LA-11 | LOW-MEDIUM | Supabase account info@preston.nyc has MFA DISABLED (Gate 0 Team page). This account owns the staging DB + all 3 projects; a credential compromise has no second factor | OWNER-VERIFIED 2026-07-22 | OPEN - owner enables MFA on the Supabase login (console hygiene; not a code change) |
